	...
	ScheduledWorkItem(MODULE_NAME, px4::wq_configurations::lp_default)
{
	...
	if (_params_av_thr_ind_en.get()) {
		_thrust_indicator = new MrThrustIndicator();
...
It is separated from other parts of the codebase in order to decouple aviant-specific features from the upstream PX4 codebase, making it easier to maintain and update PX4.
)DESCR_STR");
